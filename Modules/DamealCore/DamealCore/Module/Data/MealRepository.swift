...
public final class MealRepository: NSObject {
    ...
    public static let sharedInstance: MealRepository = {
...
extension MealRepository: MealRepositoryProtocol {
    ...
    public func getMeal(mealId: String) -> AnyPublisher<MealModel, Error> {
    ...
    public func toggleFavoriteMeal(mealId: String) -> AnyPublisher<MealModel, Error> {
