...
public final class Injection: NSObject {
    ...
    public static func provideHomeUseCase() -> HomeUseCase {
        let homeUseCase = sharedInstance.resolve(HomeUseCase.self)!
        return homeUseCase
    }

    public static func provideFavoriteUseCase() -> FavoriteUseCase {
        let favoriteUseCase = sharedInstance.resolve(FavoriteUseCase.self)!
        return favoriteUseCase
    }

    public static func provideDetailUseCase(meal: MealModel) -> DetailUseCase {
